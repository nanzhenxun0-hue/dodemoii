...
function CreditsScreen({ nickname, onClose }) {
  ...
  const playFromStart = () => {
    ...
    introTimerRef.current = setTimeout(() => setPhase("rolling"), 2600);
  };
  ...
  const handleLoadedMeta = () => {
    if (audioRef.current && audioRef.current.duration && isFinite(audioRef.current.duration)) {
      setDuration(Math.max(20, audioRef.current.duration - 1.5));
    }
  };
      ...
      {phase === "intro" && (
        <div
          style={{
            ...
            alignItems: "center",
            justifyContent: "center",
            animation: "introFadeScale 2.6s ease-in-out forwards",
          }}
        >
      ...
      {phase !== "intro" && (
        ...
        >
          ...
          >
            ...
            <div style={{ margin: "90px auto 0", color: "#4a4230", fontSize: 12 }}>・ ・ ・</div>
            <div style={{ marginTop: 20, fontSize: 11, color: "#8a7a4d", letterSpacing: 3 }}>企画・開発</div>
            <div style={{ fontSize: 18, marginTop: 10, color: "#c9a227" }}>
              {nickname || "名も無き審査官"}
            </div>

            <div style={{ margin: "80px auto 0", color: "#4a4230", fontSize: 12 }}>・ ・ ・</div>
            <div style={{ marginTop: 20, fontSize: 11, color: "#8a7a4d", letterSpacing: 3 }}>審査項目</div>
            {gameLines.map((n) => (
              <div key={n} style={{ fontSize: 14, marginTop: 10 }}>
                ★ {n}
              </div>
            ))}

            <div style={{ margin: "80px auto 0", color: "#4a4230", fontSize: 12 }}>・ ・ ・</div>
            <div style={{ marginTop: 20, fontSize: 11, color: "#8a7a4d", letterSpacing: 3 }}>裏審査</div>
            {hiddenLines.map((n) => (
              <div key={n} style={{ fontSize: 14, marginTop: 10, color: "#c9a8e8" }}>
                ★ {n}
              </div>
            ))}

            <div style={{ margin: "80px auto 0", color: "#4a4230", fontSize: 12 }}>・ ・ ・</div>
            <div style={{ marginTop: 20, fontSize: 11, color: "#8a7a4d", letterSpacing: 3 }}>審査記録管理</div>
            <div style={{ fontSize: 14, marginTop: 10 }}>Firebase Firestore</div>

            <div style={{ marginTop: 40, fontSize: 11, color: "#8a7a4d", letterSpacing: 3 }}>審査台帳運営</div>
            <div style={{ fontSize: 14, marginTop: 10 }}>Vercel</div>

            <div style={{ marginTop: 40, fontSize: 11, color: "#8a7a4d", letterSpacing: 3 }}>制作協力</div>
            <div style={{ fontSize: 14, marginTop: 10 }}>Claude</div>

            <div style={{ marginTop: 40, fontSize: 11, color: "#8a7a4d", letterSpacing: 3 }}>テーマ曲</div>
            <div style={{ fontSize: 14, marginTop: 10 }}>BREAK THE LIMIT</div>

            <div style={{ margin: "100px auto 0", color: "#4a4230", fontSize: 12 }}>・ ・ ・</div>
            <div style={{ marginTop: 30, fontSize: 11, color: "#8a7a4d", letterSpacing: 3 }}>
              そして何より
            </div>
...
export default function App() {
  ...
  return (
    <div style={wrapStyle}>
      ...
      {showCredits && <CreditsScreen nickname={nickname} onClose={closeCredits} />}
