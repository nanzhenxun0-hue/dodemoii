    ...
    >
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          animation: "creditsScroll 52s linear forwards",
          textAlign: "center",
          color: "#e8e6df",
          fontFamily: "'Zen Kaku Gothic New', sans-serif",
          padding: "0 24px",
      ...
      >
        ...
        <div style={{ marginTop: 90, fontSize: 11, color: "#8a7a4d", letterSpacing: 3 }}>企画・開発</div>
        <div style={{ fontSize: 18, marginTop: 10, color: "#c9a227" }}>
          {nickname || "名も無き審査官"}
        </div>

        <div style={{ marginTop: 80, fontSize: 11, color: "#8a7a4d", letterSpacing: 3 }}>審査項目</div>
        {gameLines.map((n) => (
        ...
        <div style={{ marginTop: 80, fontSize: 11, color: "#8a7a4d", letterSpacing: 3 }}>裏審査</div>
        {hiddenLines.map((n) => (
        ...
        <div style={{ marginTop: 80, fontSize: 11, color: "#8a7a4d", letterSpacing: 3 }}>審査記録管理</div>
...
export default function App() {
  ...
  const creditsAudioRef = useRef(null);
  ...
  const closeCredits = () => {
    if (creditsAudioRef.current) {
      ...
      creditsAudioRef.current.currentTime = 0;
    }
  ...
  useEffect(() => {
    if (showCredits && creditsAudioRef.current) {
      creditsAudioRef.current.currentTime = 0;
      creditsAudioRef.current.volume = 0.5;
      creditsAudioRef.current.play().catch(() => {});
    }
  }, [showCredits]);
  ...
  return (
    <div style={wrapStyle}>
      ...
      <audio ref={creditsAudioRef} src="/credits.mp3" />
